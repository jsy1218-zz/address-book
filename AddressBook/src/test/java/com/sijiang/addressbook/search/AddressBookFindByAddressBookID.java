...
public class AddressBookFindByAddressBookID {
	...
	@Test
	public void runAddressBookFindByAddressBookID()
		...
		try {
			...
			AddressBook addressBook = addressBookRepo.findByAddressBookId(DefaultAddressBookParams.DEFAULT_ADDRESS_BOOK_ID);
